      ...
      <div className="flex min-h-screen w-full overflow-x-hidden">
        ...
        <section className="min-w-0 flex-1 border-r border-gray-200">
          <div className="border-b border-gray-200 bg-white px-6 py-5 lg:px-8">
            <div>
              <h2 className="text-3xl font-bold tracking-tight">Supplier Sheet</h2>
              <p className="mt-0.5 text-sm text-gray-500">
                Upload, review, and manage supplier sheets.
              </p>
            </div>
          </div>
            ...
            <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
              <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                ...
                <div className="flex flex-wrap gap-3">
                  <input
                    type="text"
                    placeholder="Search sheet name, supplier, buyer..."
                    className="h-12 w-full min-w-[320px] rounded-xl border border-gray-300 bg-white px-4 text-sm text-gray-700 outline-none"
                  />
                </div>
              </div>
            </div>
                ...
                <table className="min-w-[1200px] w-full text-left">
                  <thead className="bg-[#f8fafc] text-sm text-gray-600">
                    <tr className="border-b border-gray-200">
                      ...
                      <th className="px-4 py-4 font-semibold">Sheet Name</th>
                      <th className="px-4 py-4 font-semibold">Supplier</th>
                      <th className="px-4 py-4 font-semibold">Total Rows</th>
                      <th className="px-4 py-4 font-semibold">Bad Rows</th>
                      <th className="px-4 py-4 font-semibold">Valid UPCs</th>
                      <th className="px-4 py-4 font-semibold">UPCs w/o ASIN</th>
                      <th className="px-4 py-4 font-semibold">ASIN</th>
                  ...
                  <tbody>
                    <tr>
                      <td colSpan={12} className="px-4 py-16 text-center text-sm text-gray-500">
                        No supplier sheets yet.
                      </td>
                    </tr>
                  </tbody>
                </table>
